...
- [`AndAll`](source/and.d.ts) - Returns a boolean for whether all given types are both true.
- [`OrAll`](source/or.d.ts) - Returns a boolean for whether either of all given types are true.
